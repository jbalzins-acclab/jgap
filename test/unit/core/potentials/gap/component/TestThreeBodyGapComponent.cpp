...
TEST(TestThreeBodyGapComponent, MockThreeBody) {
    ...
    force0 += sep02.direction * 0.1;
    force2 -= sep02.direction * 0.1;
    virials += sep02.virials() * 0.1;

    Separation sep01(atoms.getPositions()[0], atoms.getPositions()[1]);
    force0 += sep01.direction * 0.1;
    force1 -= sep01.direction * 0.1;
    virials += sep01.virials() * 0.1;

    Separation sep21(atoms.getPositions()[2], atoms.getPositions()[1]);
    force2 += sep21.direction * 0.1;
    force1 -= sep21.direction * 0.1;
    virials += sep21.virials() * 0.1;

    // Triplet (2,0,3)
    Separation sep20(atoms.getPositions()[2], atoms.getPositions()[0]);
    force2 += sep20.direction * 0.1;
    force0 -= sep20.direction * 0.1;
    virials += sep20.virials() * 0.1;

    Separation sep23(atoms.getPositions()[2], atoms.getPositions()[3]);
    force2 += sep23.direction * 0.1;
    force3 -= sep23.direction * 0.1;
    virials += sep23.virials() * 0.1;

    Separation sep03(atoms.getPositions()[0], atoms.getPositions()[3]);
    force0 += sep03.direction * 0.1;
    force3 -= sep03.direction * 0.1;
    virials += sep03.virials() * 0.1;
