#ifndef JGAP_ZBLRESOURCES_H
#define JGAP_ZBLRESOURCES_H
...
extern const unsigned char nlh_dat[];
extern const unsigned int nlh_dat_len;
...
static const unsigned char nlh_dat[] = {0};
static const unsigned int nlh_dat_len = 0;
