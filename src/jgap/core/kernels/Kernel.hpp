...
namespace jgap {
    ...
    public:
        ...
        /// (e.g. `double value(const Descriptor<Dim>& q1, const Descriptor<Dim>& q2) const override { return Kernel::value(q1, q2); }`)
        /// forces devirtualization of valueAndGradient for compiler optimizations.
        virtual double value(const Descriptor<Dim>& q1, const Descriptor<Dim>& q2) const {
