...
namespace jgap {
    ...
    public:
        ...
        ThreeBodyDescriptor<3> evaluateAndDifferentiate(const Cluster3& cluster) const override final {
            ...
            Real df1f2 = df1 * f2;
            desc.derivatives[0][0] = df1f2 * L1 + f1f2 * dL1_dc * dc_dr01;
            desc.derivatives[0][1] = df1f2 * L2 + f1f2 * dL2_dc * dc_dr01;
            desc.derivatives[0][2] = df1f2 * L3 + f1f2 * dL3_dc * dc_dr01;

            Real f1df2 = f1 * df2;
            desc.derivatives[1][0] = f1df2 * L1 + f1f2 * dL1_dc * dc_dr02;
            desc.derivatives[1][1] = f1df2 * L2 + f1f2 * dL2_dc * dc_dr02;
            desc.derivatives[1][2] = f1df2 * L3 + f1f2 * dL3_dc * dc_dr02;

            desc.derivatives[2][0] = f1f2 * dL1_dc * dc_dr12;
            desc.derivatives[2][1] = f1f2 * dL2_dc * dc_dr12;
            desc.derivatives[2][2] = f1f2 * dL3_dc * dc_dr12;
...
#endif // JGAP_MEAMTRANSFORMATION_HPP
