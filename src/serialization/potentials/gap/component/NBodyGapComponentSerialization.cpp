...
namespace jgap {
    ...
    using NBodySerialization13 = NBodyGapComponentSerialization<2, 3, NodeSymmetric, SquaredExpKernel<1, 1>>;
    using NBodySerialization23 = NBodyGapComponentSerialization<3, 3, NodeSymmetric, SquaredExpKernel<2, 1>>;
    using NBodySerialization33 = NBodyGapComponentSerialization<4, 3, NodeSymmetric, SquaredExpKernel<3, 1>>;
    using NBodySerialization43 = NBodyGapComponentSerialization<5, 3, NodeSymmetric, SquaredExpKernel<4, 1>>;
    ...
    template class NBodyGapComponentSerialization<2, 3, NodeSymmetric, SquaredExpKernel<1, 1>>;
    template class NBodyGapComponentSerialization<3, 3, NodeSymmetric, SquaredExpKernel<2, 1>>;
    template class NBodyGapComponentSerialization<4, 3, NodeSymmetric, SquaredExpKernel<3, 1>>;
    template class NBodyGapComponentSerialization<5, 3, NodeSymmetric, SquaredExpKernel<4, 1>>;
