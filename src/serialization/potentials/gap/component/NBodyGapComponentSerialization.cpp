...
namespace jgap {
    ...
    using NBodySerialization12 = NBodyGapComponentSerialization<2, 2, Symmetric, SquaredExpKernel<1, 1>>;
    using NBodySerialization22 = NBodyGapComponentSerialization<3, 2, Symmetric, SquaredExpKernel<2, 1>>;
    using NBodySerialization32 = NBodyGapComponentSerialization<4, 2, Symmetric, SquaredExpKernel<3, 1>>;
    ...
    template class NBodyGapComponentSerialization<3, 2, Symmetric, SquaredExpKernel<2, 1>>;
    template class NBodyGapComponentSerialization<4, 2, Symmetric, SquaredExpKernel<3, 1>>;
