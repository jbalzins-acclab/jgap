...
namespace jgap {
    ...
    PointsPerSpeciesTriplet PerSpecies3bSparsifier::sparsifyFromData(const vector<AtomicStructure> &fromData) {
        ...
        for (const auto& structure: fromData) {
            for (const auto& atom0 : structure) {
