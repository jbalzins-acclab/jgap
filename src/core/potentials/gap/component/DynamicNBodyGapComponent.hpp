#ifndef JGAP_DYNAMICNBODYGAPCOMPONENT_HPP
#define JGAP_DYNAMICNBODYGAPCOMPONENT_HPP
...
namespace jgap {
    ...
    class DynamicNBodyGapComponent : public GapComponent {
    public:
        static constexpr size_t Dependencies = Cluster<ClusterSize>::NSeparations;

        DynamicNBodyGapComponent(const SpeciesSet species,
...
#endif //JGAP_DYNAMICNBODYGAPCOMPONENT_HPP