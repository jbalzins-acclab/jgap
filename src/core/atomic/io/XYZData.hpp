...
namespace jgap {
    ...
    /**
     * Labels for the common ext-xyz property/array names that {@link XYZData#read} and {@link Atoms} use.
     *
     ...
     * in some of the {@link XYZInfoType} types,
     * and a bunch of named arrays as {@link XYZArrayType}.
     *
     * @see {@link XYZData#read} for specifics.
     *
    ...
    public:
        /**
         * Same as {@link XYZData#read(std::istream&, MainXYZPropertyNames)}, from a file.
         */
         ...
         *
         * Allowed types of properties are defined in {@link XYZInfoType},
         * however, conversion from string will be attempted only if prop_name matches one in main_props,
         * moreover, an error will be thrown if such conversion is impossible. <p>
         *
         ...
         * Type support can be found in {@link XYZArrayType}, which should be encoded as: <br>
         *  I:1 - int, <br>
         *  R:1 - {@link Real}, <br>
         *  R:3 - {@link Vector3}, <br>
         *  S:1 - string without whitespaces if (array name != main_props.species), {@link Species} otherwise. <br>
         *
