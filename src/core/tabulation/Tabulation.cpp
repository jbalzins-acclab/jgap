...
namespace jgap {
    ...
    Tabulation::Tabulation(TabulationParams defaultParams, std::optional<std::string> tableFilenamePrefix) {

    }

    std::shared_ptr<TabGapPotential> Tabulation::tabulate(const std::shared_ptr<Potential> &potential) {
    ...
    std::pair<TabulationData, TabulationData> Tabulation::makeSplineTables(
    ...
    TabulationParams Tabulation::prepareParams(const std::shared_ptr<Potential> &potential) const {
