#ifndef JGAP_ATOMICTWOBODYGRIDS_HPP
#define JGAP_ATOMICTWOBODYGRIDS_HPP
...
namespace jgap {
    ...
    struct AtomicTwoBodyGrids {
        ...
        Grid<GridDim>& getValueGrid(const Species2Atomic& species_set) {
            if (isPlaceholder()) {
        ...
        bool hasGridFor(const Species2Atomic& species_set) const {
